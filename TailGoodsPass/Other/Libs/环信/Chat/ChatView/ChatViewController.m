...
- (void)setNarBarUI {
    ...
    UIBarButtonItem *leftItem=[[UIBarButtonItem alloc]initWithImage:[[UIImage imageNamed:@"mapBack_30x30_"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(click)];
                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    if (model.isSender) {  // 自己的头像 昵称
        ...
        YXUserInfoModel *userMoel = [BXUserInfoManager getUserInfo];
        model.avatarURLPath = userMoel.PHOTOURL;
        model.nickname = userMoel.USERNAME;
    } else {   // 别人的头像昵称
//        model.avatarURLPath = message.ext[@"avatarURL"];
//        model.nickname = message.ext[@"nickname"];
        model.nickname = @"伶俐鬼";
        model.avatarURLPath = @"http://image.4008000114.com:9011/PHOTO/201709004222/Small_201709004222_20170928_135626_Image1.png";
    }

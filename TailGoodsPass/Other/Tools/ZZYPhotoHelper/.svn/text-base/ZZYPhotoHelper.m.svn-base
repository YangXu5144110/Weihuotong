...
- (void)showImageViewSelcteWithResultBlock:(ZZYPhotoHelperBlock)selectImageBlock{
    ...
    UIAlertAction * library = [UIAlertAction actionWithTitle:@"拍照" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
//            [MBProgressHUD showError:@"相机功能暂不能使用"];
            [SVProgressHUD showErrorWithStatus:@"相机功能暂不能使用"];
            
        }

    }];
    UIAlertAction * carmare = [UIAlertAction actionWithTitle:@"从手机相册选择" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
